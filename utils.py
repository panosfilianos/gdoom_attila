...
def test_environment(weights, scenario = 'basic', window = False, total_episodes = 100, enhance = 'dueling', frame_skip = 2, stack_size = 4):
    """
    Description
    ---------------
...
#             action, explore_probability = predict_action(1, 0.01, 0.0001, 1e6, state.cuda(), model, possible_actions)
        ...
        print ("Total reward:", game.get_total_reward(), "Kills:", game.get_game_variable(KILLCOUNT))
        time.sleep(0.1)
